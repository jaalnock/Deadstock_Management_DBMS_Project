...
// const prob = await insertProblem(302,1,203,508, "Software missing", '2023-12-07', "Added GCC", '2023-12-11');
// console.log(prob);

// const deadstock1 = await getDeadStock(302,1,203);
// console.log(deadstock1);

// const hc1 = await getHistoryCard(302,1,203);
// console.log(hc1);

// const upDeadStock1 = await updateDeadStock(302,1,203,'windows 12,intel core i7,8gb ram');
// console.log(upDeadStock1);
